...
Brain Maps AJAX-Zoomify viewer
http://brainmaps.org/index.php?p=brain-maps-api

"The Brain Maps AJAX-Zoomify viewer may be used with your own Zoomify
images. It is much faster than Flash-based version. Future versions will
enable you to add overlays to brain maps (including markers and polylines)
and display shadowed "info windows". The Brain Maps API is a free service,
